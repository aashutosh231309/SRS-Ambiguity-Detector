...
/**
 * Issue-category summary for ONE analysis (Stage 09 report section, not
 * dashboard analytics). Horizontal bars per UI_UX_SPEC §7 — readable labels
 * beat pie slices; a single restrained color (never rainbow categories). The
 * list itself is the accessible alternative (counts are real text; bars are
...
export function CategoryBars({ counts }: { counts: CategoryCount[] }) {
  ...
  return (
    <section aria-labelledby={headingId}>
      ...
      <p className="mt-1 text-[13px] leading-relaxed text-ink-faint">
        Counts within this analysis only — not account-wide trends.
      </p>
