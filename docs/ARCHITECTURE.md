...
| `RATE_LIMIT_*` | all (Stage 04 ✅ + Stage 06 ✅ + Stage 08 ✅ + Stage 12 ✅ + Stage 19 ✅) | Auth buckets + per-user analysis bucket (`RATE_LIMIT_ANALYSIS_PER_MINUTE`, default 20) + per-user upload bucket (`RATE_LIMIT_UPLOADS_PER_MINUTE`, default 10) + per-user AI-test bucket (`RATE_LIMIT_AI_TEST_PER_MINUTE`, default 10) + per-user download-mint bucket (`RATE_LIMIT_DOCUMENT_DOWNLOAD_PER_MINUTE`, default 10), single-process (distributed Stage 22) |
