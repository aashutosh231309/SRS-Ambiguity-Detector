"""Analysis business logic (API_CONTRACT §4.3, Stage 07: TEXT + engine).
...
async def create_text_analysis(
    ...
    *,
    ...
    """Validate → normalize → segment → detect → score → persist. Raises
    AppError (safe codes); any failure rolls the transaction back — partial
...
async def delete_analysis(
    ...
    owned — foreign ids are indistinguishable from missing ones."""
